...
Public Class Legalizacion_rechazada
    Private dataView As New DataView

    'Cargo las legalizaciones una vez ingresen al formulario
    Private Sub Legalizacion_rechazada_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub ListarLegalizaciones()
        ...
        Dim resultado = modeloLegalizacion.ListarLegalizaciones("RECHAZADA")
