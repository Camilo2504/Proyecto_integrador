...
Public Class Aprobador_form
    ...
    Private Sub Aprobador_form_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Security()
        ManagePermissions()
        UserInfo()
    End Sub
    ...
    Private Sub LegaPendiente_Click(sender As Object, e As EventArgs) Handles LegaPendiente.Click
        ActiveButton(sender, Color.FromArgb(172, 126, 241))
        OpenChildForm(New Legalizacion_pendiente)
    End Sub

    'Click en el botón de listar usuarios
    Private Sub LegaAprobada_Click(sender As Object, e As EventArgs) Handles LegaAprobada.Click
        ActiveButton(sender, Color.FromArgb(249, 118, 176))
        OpenChildForm(New Legalizacion_aprobada)
    End Sub

    'Click en el botón de editar usuario
    Private Sub LegaRechazada_Click(sender As Object, e As EventArgs) Handles LegaRechazada.Click
        ActiveButton(sender, Color.FromArgb(253, 138, 114))
        OpenChildForm(New Legalizacion_rechazada)
    End Sub
